> ℹ️ **Архивная ветка (PoC Baseline):**
> Эта ветка содержит исходную легковесную версию проекта с минимальными зависимостями.
> Активная разработка Enterprise-решения ведется в ветке `main`.
