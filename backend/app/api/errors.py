...
Разделение ответственности:
  ...
  - `detail` — диагностика для серверного журнала. Для 5xx обработчик заменяет
    её безопасным сообщением. Клиент никогда не выводит сырой detail: если код
    неизвестен, показывает локализованное сообщение об обращении в поддержку.
