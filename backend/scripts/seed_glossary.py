...
from scripts.audit_glossary_identities import load_rules
...
def main() -> int:
    ...
    parser.add_argument("--rules-file", type=Path, help="explicit user rule JSON path")
    args = parser.parse_args()
    report = seed_glossary(GlossaryRegistry(), load_seed(args.path), apply=args.apply, rules=load_rules(args.rules_file))
