...
.DESCRIPTION
    Kills processes by PID files in %TEMP%\opencode and by ports 16333/12400/5432/18000/16300.
...
foreach ($p in 16333, 12400, 5432, 18000, 16300) {
