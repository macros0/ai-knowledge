...
export function AutoThemeIcon({ size = 16 }) {
  // «Половина круга»: заполненная правая половина + обводка по кругу.
  // Заполнение рисуем ДО обводки, чтобы контур оставался целым; лёгкая
  // прозрачность (opacity 0.85) не даёт заливке слиться с обводкой на 16px.
  return (
    <svg
      width={size}
      height={size}
